...
plot(z, hpdata$Global_active_power, type="l", xlab = " ", ylab = "Global Active Power") #1st plot

plot(z, hpdata$Sub_metering_1, type = "l", xlab = " ", ylab = "Engerging sub metering")
...
plot(z, hpdata$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")  #3rd plot
plot(z, hpdata$Global_active_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power") #4th plot
